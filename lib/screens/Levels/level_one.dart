...
class _LevelOneState extends State<LevelOne> {
  ...
  Future<void> getData() async {
    final String response = await rootBundle.loadString('lib/assets/1.json');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Center(child: Text('Level 1', style: TextStyle(color: Colors.black))),
            Text(
              'English Learning',
              style: TextStyle(
                color: Colors.black,
